...
const faqs = [
  { q: 'Para qual idade é indicado o programa?', a: 'O Kids Fit foi desenvolvido especialmente para crianças de <strong>5 a 14 anos</strong> com excesso de peso ou sobrepeso. Todas as receitas, exercícios e estratégias são adaptados para essa faixa etária.' },
